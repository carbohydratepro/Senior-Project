...
def main():
    ...
    for key, value in tqdm(title_vectors.items()):
        ...
        title_similarities = dict(sorted(title_similarities.items(), key=lambda item: item[1]))
    ...
    for key, value in tqdm(content_vectors.items()):
        ...
        content_similarities = dict(sorted(content_similarities.items(), key=lambda item: item[1]))
